...
4. Modanet dataset (https://github.com/eBay/modanet)

The Modanet dataset contains 13 semantic labels (such as bag, belt, boots,
and so on) for street fashions.
...
References:
  ...
  Shuai Zheng and Fan Yang and M. Hadi Kiapour and Robinson Piramuthu, "ModaNet: 
  A Large-Scale Street Fashion Dataset with Polygon Annotations", ACM Multimedia,
  2018
"""
